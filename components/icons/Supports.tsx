...
export function GPaySupport() {
  const copyText = async () => {
    await navigator.clipboard.writeText("rishabhshukla2924-1@okicici");
    toast.success("Copied UPI-Id to clipboard!");
  };
  return (
    <div
      className="p-2 rounded-md border border-white/20 bg-transparent hover:bg-white/10 transition flex gap-1 cursor-pointer"
      onClick={copyText}
    >
      <svg
